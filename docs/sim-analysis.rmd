...
validity <- inner_join(validity, param, by="sim")
...
validity$n[validity$hypothesis == "yx"] <- validity$nidy[validity$hypothesis == "yx"]
...
ggplot(filter(validity_sl, strategy != "oracle"), aes(x=strategy, y=value)) +
...
ggplot(filter(validity_sl, strategy != "oracle"), aes(x=nbin, y=value)) +
